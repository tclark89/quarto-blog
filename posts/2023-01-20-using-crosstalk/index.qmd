...
#| echo: false
sharedMtCars2 <- SharedData$new(mtcars)

filter_checkbox("cyl", "Cylinders", sharedMtCars2, ~cyl, inline=T)
filter_select("am", "Automatic", sharedMtCars2, ~am)
filter_slider("disp", "Displacement", sharedMtCars2, ~disp)

foo <- summarywidget(sharedMtCars2, statistic = "count", digits=0)
```
::::
...
You have selected `r summarywidget(sharedMtCars2, statistic = "count", digits=0)` cars.