...
Now that we have the data, lets make these charts! We'll use 
  `ggplot` again.
...
Technically, this is all you need for a set of X-bar and S charts. You'd probably
  want to put some labels on there, and the plots are often shown together with 
  the X-Bar chart above the S chart, aligned on the x-axis. 
